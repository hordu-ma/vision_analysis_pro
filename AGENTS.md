...
- Current lightweight local backend baseline is `215 passed, 44 skipped`; skips are expected when legacy `models/best.onnx`, `data/images/*`, or optional local model artifacts are absent.
